            ...
            <div class="row">
                <div class="col-md-8">
                    <div id="serv_hover" class="room room-details">
                        <div class="room-img">
                            <img src="/room/{{ $cox->image }}" alt="Room Image" />
                        </div>
                        <div class="bed_room">
                            <h3>Room Title : {{ $cox->room_title }}</h3>
                            <p>Room Description : {{ $cox->description }}</p>
                            <h4>Free Wifi : {{ $cox->wifi }}</h4>
                            <h4>Room Type : {{ $cox->room_type }}</h4>
                            <h3>Price : {{ $cox->price }}</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="book-room">
                        ...
                        <form action="{{ url('add_booking', $cox->id) }}" method="POST">
                            @csrf
