            ...
            <div class="container-fluid">
                ...
                <table class="table_deg">
                    ...
                    <tr>
                        ...
                        <td>
                            <a onclick="return confirm('Are you sure to delete this?');" class="btn btn-danger" href="{{ url('coxroom_update', $data->id) }}">Delete</a>
                        </td>
                        <td>
                            <a class="btn btn-warning" href="{{ url('coxroom_update', $data->id) }}">Update</a>
                        </td>
                    </tr>
                    @endforeach
                </table>
