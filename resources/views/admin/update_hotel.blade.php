        ...
        <div class="page-header">
            <div class="container-fluid">
                <div class="div_center">
                    ...
                    <form action="{{ url('edit_hotel', $data->id) }}" method="Post" enctype="multipart/form-data">
                        @csrf

                        <div class="div_deg form-group">
                            <label for="name">Hotel Name:</label>
                            <input type="text" name="name" id="name" value="{{ $data->hotel_name }}">
                        </div>
                        ...
                        <div class="div_deg form-group">
                            <input class="btn btn-primary" type="submit" value="Update Hotel">
                        </div>
